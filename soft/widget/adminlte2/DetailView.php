...
class DetailView extends \yii\widgets\DetailView
{
     ...
     * Agar false bo'lsa, panel render bo'lmaydi
     * Agar null bo'lsa va ajax so'rov bo'lsa, panel render bo'lmaydi
     * Agar array bo'lsa, BoxWidget render bo'ladi
     * @see BoxWidget
     */
    public $panel;
    ...
    public function run()
    {
        ...
        if ($this->panel === null && Yii::$app->request->isAjax){
            $this->panel = false;
        }
    ...
    public function renderToolbar()
    {
        ...
        return Html::tag('div', $content, ['class' => 'pull-right', 'style' => 'margin-bottom:10px']);
    }
