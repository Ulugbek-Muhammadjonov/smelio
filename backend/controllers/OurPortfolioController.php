...
use common\models\search\OurPortfolioSearch;
use soft\web\SoftController;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

class OurPortfolioController extends SoftController
{
    ...
    {
        $searchModel = new OurPortfolioSearch();
    ...
    {
        $model = OurPortfolio::find()->andWhere(['id' => $id])->one();
        if ($model == null) {
            not_found();
        }
        return $model;
