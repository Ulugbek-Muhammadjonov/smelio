...
use Yii;
use common\models\OurAward;
use common\models\search\OurAwardSearch;
use soft\web\SoftController;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

class OurAwardController extends SoftController
{
    ...
    */
    ...
    {
        $searchModel = new OurAwardSearch();
    ...
    */
    ...
    {
        $model = OurAward::find()->andWhere(['id' => $id])->one();
        if ($model == null){
            not_found();
        }
        return $model;
